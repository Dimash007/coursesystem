...
namespace CourseSystem.Controllers
{
    public class DirectionsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Description")] Direction direction)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Description")] Direction direction)
        {
            if (id != direction.Id)
            {
                return NotFound();
